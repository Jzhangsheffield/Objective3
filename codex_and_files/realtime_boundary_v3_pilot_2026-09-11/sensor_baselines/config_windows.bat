...
REM Canonical v2 maps source timestamps to valid reference frames before indexing.
...
if not defined CACHE_ROOT set "CACHE_ROOT=%PACKAGE_ROOT%\cache\canonical_v3"
if not defined OUTPUTS_ROOT set "OUTPUTS_ROOT=%PACKAGE_ROOT%\outputs_canonical_v3"
if not defined SMOKE_OUTPUTS_ROOT set "SMOKE_OUTPUTS_ROOT=%PACKAGE_ROOT%\outputs_smoke_canonical_v3"
