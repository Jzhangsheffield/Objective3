...
if not defined OBJ2_ROOT set "OBJ2_ROOT=D:\Junxi_data\Objective3_thermal_crimp\obj2_codes"
...
if not defined MODEL_ROOT set "MODEL_ROOT=%OUTPUT_ROOT%\history_models\existing_last"
